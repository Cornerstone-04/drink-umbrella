...
export const metadata = {
  ...
  description: "Umbrella Ogogoro: a premium organic Nigerian-British spirit, crafted from organically sourced cane, corn and coconut.",
  openGraph: { title: "Drink Umbrella", description: "Heritage. Craft. Sustainability." },
};
    ...
    <>
      ...
      <section className="relative h-[100svh] min-h-[640px] w-full overflow-hidden">
        ...
        <div className="relative z-10 flex h-full flex-col justify-end pb-20 text-bone container-edge">
          ...
          <h1 className="mt-6 max-w-5xl font-display text-[clamp(3rem,9vw,9rem)] leading-[0.9] reveal">
            A taste of the
            <br />
            <span className="font-serif italic font-light text-sun">premium</span> African spirit.
          </h1>
          <p className="mt-8 max-w-xl text-base text-bone/80 fade-up">
            Crafted from organically sourced cane, corn and coconut. Born in Bayelsa,
            bottled for the world.
          </p>
        ...
        <div className="absolute bottom-6 right-6 z-10 hidden font-mono text-[10px] uppercase tracking-[0.4em] text-bone/60 md:block">
          Scroll &darr;
        </div>
      </section>

      {/* Marquee */}
      <Marquee items={["Organic", "80 Proof", "Batch Made", "Vegan Friendly", "Low Sugar", "Gluten Free", "Sustainable"]} />
      ...
      <section className="container-edge grid gap-16 py-32 md:grid-cols-12">
        <FadeIn className="md:col-span-5">
          ...
          <h2 className="mt-6 font-display text-5xl md:text-7xl text-balance">
            Right place. <em className="font-serif italic font-light text-sun-deep">Right time.</em>
          </h2>
        </FadeIn>
        <FadeIn className="md:col-span-6 md:col-start-7 space-y-6 text-lg leading-relaxed text-ink/80" delay={0.15}>
          <p>
            Umbrella Ogogoro is a premium organic Nigerian-British spirit inspired by the
            rich cultural heritage of West Africa &mdash; a category long owned by foreign
            houses, finally reclaimed.
          </p>
          <p>
            We craft a distinct, organic alcoholic beverage that honours African roots
            while promoting sustainability and ethical practices at every step.
          </p>
          <p>
            Born in the creeks of Bayelsa, finished in Lagos, shipped from London. One
            bottle, one expression, three cities &mdash; built by a small team of Nigerian
            and British creatives who grew up on either side of the Atlantic and decided
            the African spirits aisle was overdue a serious entry.
          </p>
          <Link
            href="/story"
        ...
        <div className="container-edge grid items-center gap-16 py-32 md:grid-cols-2">
          ...
          <FadeIn direction="right" delay={0.1}>
            ...
            <h2 className="mt-6 font-display text-5xl md:text-6xl text-balance">
              Our home<br/>made <em className="font-serif italic font-light text-sun">stuff.</em>
            </h2>
            <p className="mt-8 max-w-md text-bone/70">
              &ldquo;Marshmallow, a hint of butterscotch pudding, cotton candy and molasses
              hit the nose while subtle floral and herbal aromas show through.&rdquo;
            </p>
            ...
            <dl className="mt-12 grid grid-cols-3 gap-8 border-t border-bone/10 pt-8">
              {[
                ...
                <div key={s.k}>
                  <dt className="font-mono text-[10px] uppercase tracking-[0.3em] text-bone/50">{s.k}</dt>
        ...
        <div className="grid gap-12 md:grid-cols-12">
          <FadeIn className="md:col-span-5">
            ...
            <h2 className="mt-6 font-display text-5xl md:text-6xl">
              Distilled by hand,<br/><em className="font-serif italic font-light text-sun-deep">honoured</em> by tradition.
            </h2>
            <p className="mt-8 text-ink/70">
              From organic Bayelsa sugarcane to copper-pot distillation, every batch is a
              tribute to the families that have brewed Ogogoro for generations.
            </p>
            <Link
              href="/process"
          ...
          <div className="grid gap-10 md:grid-cols-12 md:items-end">
            <FadeIn className="md:col-span-5">
              ...
              <h2 className="mt-4 font-display text-5xl md:text-6xl">
                Small house. <em className="font-serif italic font-light">Real footprint.</em>
              </h2>
            </FadeIn>
            <FadeIn className="md:col-span-6 md:col-start-7 text-ink/80 leading-relaxed" delay={0.1}>
              We are a young brand on purpose &mdash; small batches, signed contracts with
              every farm, and zero diesel in the production chain. The math, today.
            </FadeIn>
          </div>

          <dl className="mt-16 grid gap-px bg-ink/10 sm:grid-cols-2 lg:grid-cols-4">
            {[
              { k: "Source farms", v: "47", sub: "All organic, all contracted" },
              { k: "Solar coverage", v: "100%", sub: "Of distillery operations" },
              ...
              <FadeIn key={s.k} delay={i * 0.08}>
                <div className="bg-sun p-8">
                  <dt className="font-mono text-[10px] uppercase tracking-[0.3em] text-ink/55">{s.k}</dt>
      ...
      <section className="relative h-[80vh] min-h-[480px] w-full overflow-hidden">
        ...
        <div className="container-edge relative z-10 flex h-full flex-col justify-end pb-20 text-bone">
          <FadeIn>
            <p className="font-mono text-[11px] uppercase tracking-[0.4em] text-sun">#DrinkUmbrella</p>
            <h2 className="mt-4 max-w-3xl font-display text-5xl md:text-7xl text-balance">
              For the parties that <em className="font-serif italic font-light text-sun">never</em> end.
            </h2>
          </FadeIn>
        </div>
      </section>
      ...
      <section className="container-edge py-32 text-center">
        <FadeIn>
          ...
          <h2 className="mt-6 font-display text-6xl md:text-8xl text-balance">
            Heritage in <em className="font-serif italic font-light text-sun-deep">every</em> sip.
          </h2>
          <Link
            href="/contact"
